...
JNIEXPORT jstring JNICALL Java_com_test_TestHelloLib_getText(JNIEnv * env, jobject jobj)
{
   return (*env)->NewStringUTF(env, (char *)"JNITest Native String");
}
JNIEXPORT jint JNICALL Java_com_test_TestHelloLib_getSum(JNIEnv * env, jobject jobj,jint a,jint b)
{
   return (a+b);
}
